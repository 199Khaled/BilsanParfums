...
{
    public class clsFlakonsData
    {
        //#nullable enable

        public static bool GetFlakonsInfoByID(int? FlakonID , ref string Form, ref string Verschlussart, ref string Farbe, ref int FlakonsMengeInMl, ref int Flakons_pro_Karton, ref int Kartons_Lager, ref int? Verbleibende_Flakons, ref DateTime? Erstellungsdatum)
{
    bool isFound = false;
                ...
                { 
                    if (reader.Read())
                    {
                        ...
                        isFound = true;
                                ...
                                FlakonsMengeInMl = (int)reader["FlakonsMengeInMl"];
        ...
        public static DataTable GetAllFlakons()
{
    ...
    return dt;
        ...
        public static int? AddNewFlakons(int FlakonsMengeInMl, int Flakons_pro_Karton, int Kartons_Lager, int? Verbleibende_Flakons, DateTime? Erstellungsdatum, string Form = null, string Verschlussart = null, string Farbe = null)
    {
        int? FlakonID = null;
        ...
        public static bool UpdateFlakonsByID(int? FlakonID, int FlakonsMengeInMl, int Flakons_pro_Karton, int Kartons_Lager, int? Verbleibende_Flakons, DateTime? Erstellungsdatum, string Form = null, string Verschlussart = null, string Farbe = null)
{
    int rowsAffected = 0;
